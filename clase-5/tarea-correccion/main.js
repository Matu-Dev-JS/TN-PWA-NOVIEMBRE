...
var Historial = /** @class */ (function () {
    ...
    Historial.prototype.eliminarAccionPorID = function (id_buscado) {
        var posicion_accion_buscada = this.lista_acciones.findIndex(function (accion_buscada) { return accion_buscada.id === id_buscado; });
        if (posicion_accion_buscada !== -1) {
            var accion_buscada = this.lista_acciones[posicion_accion_buscada];
